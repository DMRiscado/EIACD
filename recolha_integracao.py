...
df_melbourne.rename(columns = {'Lattitude':'lattitude'}, inplace = True)
df_melbourne.rename(columns = {'Longtitude':'longtitude'}, inplace = True)
...
df_perth.rename(columns = {'NEAREST_SCH':'nearest_stn'}, inplace = True)
